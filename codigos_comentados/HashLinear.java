//HashLinear
 ...
 //implementa uma tabela hash com tratamento de colisões via sondagem linear
...
public class HashLinear {
    ...
    //cria uma instancia da tabela hash linear
    ...
    //insere um novo registro na tabela hash, tratando rehash conforme o método linear, e retorna o numero de colisoes encontrado
    public long inserirRegistro(Registro registro) {
        ...
        //caso a tabela encha, ou passe do fator de carga maximo, faz rehash
        while (ocupado[pos]) {
            pos = (pos + 1);
    ...
    // busca registros na tabela a partir do seu codigo, se nao existir retorna false
    ...
    // rehash, caso o numero de valores estoure o tamanho da tabela, o tamanho dobra e os valores que ja existiam sao redistribuidos, depois volta pra inserção
    private void rehash() {
    ...
    // método hash por divisao, separando valor gerado em fatias e evitando valores negativos
    ...
    //retorna lista com o tamanho de todos os gaps encontrados na tabela
